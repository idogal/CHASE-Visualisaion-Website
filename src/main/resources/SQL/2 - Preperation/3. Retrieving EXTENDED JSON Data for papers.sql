...
WHERE NOT EXISTS (SELECT * FROM Papers_Academic_Info AS I WHERE I.Paper_ID = [Papers_List].ID AND I.Extended_Academic_Info IS NOT NULL)
);
...
BEGIN
	...
	DECLARE @Output_Text varchar(MAX);
    ...
    IF (NOT EXISTS (SELECT * FROM Papers_Academic_Info AS I WHERE I.Paper_ID = @Paper_ID AND I.Extended_Academic_Info IS NOT NULL))
		UPDATE Papers_Academic_Info
		SET Extended_Academic_Info = @Output_Text
